...
return [
    ...
    'dashboard' => [
        ...
        '/dashboard/urban-planning' => 'resources/views/pages/dashboard/urban_planning_integration.php',
        '/dashboard/utilities' => 'resources/views/pages/dashboard/utilities_integration.php',
        '/dashboard/road-transpo' => 'resources/views/pages/dashboard/road_transpo_integration.php',
        '/dashboard/energy-efficiency' => 'resources/views/pages/dashboard/energy_efficiency_integration.php',
