...
$pageTitle = frs_t('home.page_title');
...
$statusLabels = [
    'available' => frs_t('home.status_available'),
    'maintenance' => frs_t('home.status_maintenance'),
    'offline' => frs_t('home.status_offline'),
];
...
<section class="reservation-hero" aria-label="<?= frs_te('home.hero_aria'); ?>">
    ...
    <div class="reservation-hero-content">
        <p class="reservation-hero-eyebrow home-animate home-animate-delay-1"><?= frs_te('home.hero_eyebrow'); ?></p>
        <h1 class="reservation-hero-title home-animate home-animate-delay-2"><?= frs_te('home.hero_title'); ?></h1>
        ...
        <p class="reservation-hero-lead home-animate home-animate-delay-4">
            <?= frs_te('home.hero_lead'); ?>
        </p>
        <div class="reservation-hero-ctas home-animate home-animate-delay-5">
            <a href="<?= $base; ?>/facilities" class="reservation-hero-cta reservation-hero-cta-solid"><?= frs_te('home.hero_cta_browse'); ?></a>
            <a href="<?= $base; ?>/register" class="reservation-hero-cta reservation-hero-cta-outline"><?= frs_te('home.hero_cta_register'); ?></a>
        </div>
    </div>

    <?php if (!empty($announcements)): ?>
    <aside class="hc-widget" aria-label="<?= frs_te('home.updates_aria'); ?>">
        <div class="hc-widget-head">
            <span class="hc-widget-title"><?= frs_te('home.updates_title'); ?></span>
            <button type="button" class="hc-widget-toggle" id="hcAutoToggle" aria-pressed="true">&#9679; <?= frs_te('home.updates_slide_toggle'); ?></button>
        </div>
        <div class="hc-widget-body">
            ...
            ?>
                <a href="<?= htmlspecialchars($base . '/announcements'); ?>" class="hc-slide<?= $i === 0 ? ' is-active' : ''; ?>">
                    ...
                    <strong class="hc-slide-title"><?= htmlspecialchars((string)($item['title'] ?? frs_t('home.announcement_fallback_title'))); ?></strong>
        ...
        <p class="hc-widget-hint"><?= frs_te('home.updates_hint'); ?></p>
    </aside>
    <?php endif; ?>
</section>
...
<section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(180deg, #ffffff 0%, #f0fdf4 100%);">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16 home-animate">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-900"><?= frs_te('home.how_title'); ?></h2>
            <div class="h-1 w-16 bg-emerald-600 rounded-full mx-auto mt-4 mb-4"></div>
            <p class="text-gray-600 text-lg"><?= frs_te('home.how_subtitle'); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="home-how-card home-animate home-animate-delay-1 text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?= frs_te('home.how_step1_title'); ?></h3>
                <p class="text-gray-500 text-sm"><?= frs_te('home.how_step1_text'); ?></p>
            </div>
            ...
            <div class="home-how-card home-animate home-animate-delay-2 text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?= frs_te('home.how_step2_title'); ?></h3>
                <p class="text-gray-500 text-sm"><?= frs_te('home.how_step2_text'); ?></p>
            </div>
            ...
            <div class="home-how-card home-animate home-animate-delay-3 text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?= frs_te('home.how_step3_title'); ?></h3>
                <p class="text-gray-500 text-sm"><?= frs_te('home.how_step3_text'); ?></p>
            </div>
            ...
            <div class="home-how-card home-animate home-animate-delay-4 text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?= frs_te('home.how_step4_title'); ?></h3>
                <p class="text-gray-500 text-sm"><?= frs_te('home.how_step4_text'); ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(180deg, #ecfdf5 0%, #ffffff 100%);">
    <div class="max-w-6xl mx-auto">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-10 home-animate">
            <div>
                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900"><?= frs_te('home.announcements_title'); ?></h2>
                <p class="text-gray-600 text-lg mt-2"><?= frs_te('home.announcements_subtitle'); ?></p>
            </div>
            <a href="<?= $base; ?>/announcements" class="inline-flex items-center whitespace-nowrap text-emerald-700 font-semibold hover:text-emerald-800">
                <?= frs_te('home.announcements_see_all'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <a href="<?= htmlspecialchars($base . '/announcements'); ?>" class="lg:col-span-2 relative rounded-2xl overflow-hidden group home-animate block" style="min-height:360px;">
                ...
                <div class="absolute bottom-0 left-0 p-6 sm:p-8 text-white">
                    ...
                    <h3 class="text-2xl sm:text-3xl font-bold mb-2"><?= htmlspecialchars($featuredAnnouncement['title'] ?? frs_t('home.announcement_fallback_title')); ?></h3>
                ...
                ?>
                    <a href="<?= htmlspecialchars($base . '/announcements'); ?>" class="home-announcement-card home-animate home-animate-delay-<?= min($index + 1, 5); ?> flex gap-3 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <h4 class="text-sm font-bold text-gray-900 line-clamp-2 mt-0.5"><?= htmlspecialchars($item['title'] ?? frs_t('home.announcement_fallback_title')); ?></h4>
        ...
        <div class="text-center mt-12 home-animate">
            <a href="<?= $base; ?>/announcements" class="inline-flex items-center px-6 py-3 bg-emerald-600 text-white font-semibold rounded-lg shadow-lg hover:bg-emerald-700 hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5">
                <?= frs_te('home.announcements_view_all'); ?>
...
<section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(180deg, #ffffff 0%, #dcfce7 50%, #f0fdf4 100%);">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16 home-animate">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-900"><?= frs_te('home.featured_title'); ?></h2>
            <div class="h-1 w-16 bg-emerald-600 rounded-full mx-auto mt-4 mb-4"></div>
            <p class="text-gray-600 text-lg"><?= frs_te('home.featured_subtitle'); ?></p>
        </div>
                ...
                <a href="<?= htmlspecialchars($detailUrl); ?>" class="home-facility-card home-animate home-animate-delay-<?= min($index + 1, 5); ?> block bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group">
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <span class="absolute top-4 right-4 px-3 py-1.5 bg-white/95 backdrop-blur-sm text-emerald-700 font-semibold text-sm rounded-full shadow-sm">
                            <?= htmlspecialchars($statusLabels[$facility['status']] ?? ucfirst((string)$facility['status'])); ?>
                        </span>
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2">
                            <?= htmlspecialchars($facility['description'] ?? frs_t('home.facility_no_description')); ?>
                        </p>
                        <span class="inline-flex items-center text-emerald-700 font-semibold text-sm">
                            <?= frs_te('home.view_details'); ?>
...
<section class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(180deg, #f0fdf4 0%, #ffffff 100%);">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16 home-animate">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-900"><?= frs_te('home.info_title'); ?></h2>
            <div class="h-1 w-16 bg-emerald-600 rounded-full mx-auto mt-4 mb-4"></div>
            <p class="text-gray-600 text-lg"><?= frs_te('home.info_subtitle'); ?></p>
        </div>
            ...
            <div class="space-y-6">
                <div class="home-info-box home-animate-left home-animate-delay-1 bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-emerald-50 to-green-50 border-b-2 border-emerald-600">
                        ...
                        <h3 class="text-lg font-bold text-emerald-900"><?= frs_te('home.hours_title'); ?></h3>
                    </div>
                    <div class="p-6 space-y-4">
                        <div class="flex justify-between items-start py-3 border-b border-gray-100">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.hours_weekdays'); ?></span>
                            <span class="text-gray-900 text-right">8:00 AM - 5:00 PM</span>
                        </div>
                        <div class="flex justify-between items-start py-3 border-b border-gray-100">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.hours_saturday'); ?></span>
                            <span class="text-gray-900 text-right">8:00 AM - 12:00 PM</span>
                        </div>
                        <div class="flex justify-between items-start py-3">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.hours_sunday'); ?></span>
                            <span class="text-gray-900 text-right"><?= frs_te('home.hours_closed'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="home-info-box home-animate-left home-animate-delay-2 bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-emerald-50 to-green-50 border-b-2 border-emerald-600">
                        ...
                        <h3 class="text-lg font-bold text-emerald-900"><?= frs_te('home.contact_title'); ?></h3>
                    </div>
                    <div class="p-6 space-y-4">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start py-3 border-b border-gray-100 gap-1">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.contact_phone'); ?></span>
                            <span class="text-gray-900">(02) 1234-5678</span>
                        </div>
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start py-3 border-b border-gray-100 gap-1">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.contact_mobile'); ?></span>
                            <span class="text-gray-900">0912-345-6789</span>
                        </div>
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start py-3 border-b border-gray-100 gap-1">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.contact_email'); ?></span>
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start py-3 gap-1">
                            <span class="font-semibold text-gray-600"><?= frs_te('home.contact_address'); ?></span>
            ...
            <div class="space-y-6">
                <div class="home-info-box home-animate-right home-animate-delay-1 bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-emerald-50 to-green-50 border-b-2 border-emerald-600">
                        ...
                        <h3 class="text-lg font-bold text-emerald-900"><?= frs_te('home.facilities_list_title'); ?></h3>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-3">
                ...
                <div class="home-info-box home-animate-right home-animate-delay-2 bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-emerald-50 to-green-50 border-b-2 border-emerald-600">
                        ...
                        <h3 class="text-lg font-bold text-emerald-900"><?= frs_te('home.requirements_title'); ?></h3>
                    </div>
                    <div class="p-6">
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3 py-2 text-gray-900 font-medium">
                                ...
                                <?= frs_te('home.req_valid_id'); ?>
                            </li>
                            <li class="flex items-center gap-3 py-2 text-gray-900 font-medium">
                                <svg class="w-5 h-5 text-emerald-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <?= frs_te('home.req_verified_email'); ?>
                            </li>
                            <li class="flex items-center gap-3 py-2 text-gray-900 font-medium">
                                <svg class="w-5 h-5 text-emerald-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <?= frs_te('home.req_complete_form'); ?>
                            </li>
                            <li class="flex items-center gap-3 py-2 text-gray-900 font-medium">
                                <svg class="w-5 h-5 text-emerald-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <?= frs_te('home.req_approval'); ?>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="mt-10 home-animate">
            <div class="flex flex-col sm:flex-row items-start gap-4 p-6 rounded-2xl border-l-4 border-emerald-600 bg-emerald-50">
                ...
                <div>
                    <strong class="block text-gray-900 mb-2"><?= frs_te('home.notice_label'); ?></strong>
                    <p class="text-gray-700 text-sm sm:text-base mb-0"><?= frs_te('home.notice_text'); ?></p>
                </div>
            </div>
        </div>
    </div>
