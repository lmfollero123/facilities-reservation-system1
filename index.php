...
if ($path === 'announcements') {
    ...
    $dashboardJsonPostRoutes = [
        ...
        'cimm-maintenance-request-api',
        'maintenance-insight-explain-api',
        'facility-recommendations',
        'booking-smart-hints',
        'ai-conflict-check',
        'facility-blackout-dates-api',
    ...
    $dashboardRouteMap = [
        ...
        'facility-blackout-dates-api' => 'facility_blackout_dates_api.php',
        ...
        'maintenance-insight-explain-api' => 'maintenance-insight-explain-api.php',
